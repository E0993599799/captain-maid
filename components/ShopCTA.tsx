...
export const ShopCTA = () => {
  ...
  return (
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-teal-700 via-teal-600 to-emerald-700">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              variant="primary"
              className="bg-white text-teal-700 hover:bg-white/90 border-0"
            >
              Shop Now
            </Button>
            <Button
