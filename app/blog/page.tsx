      ...
      <div className="container-safe">
        ...
        {posts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-lg mb-2xl">
            {posts.map((post) => (
              <Link key={post.id} href={`/${locale}/blog/${post.slug}`} className="group flex flex-col h-full bg-captain-light rounded-sm overflow-hidden border border-captain-light hover:border-captain-blue hover:shadow-lg transition-all">
