...
test('hero uses the approved responsive artwork at each breakpoint', () => {
  ...
  assert.match(hero, /captain-maid-hero-mobile\.jpg/)
  assert.match(hero, /captain-maid-hero-tablet\.jpg/)
  assert.match(hero, /captain-maid-hero-desktop\.jpg/)
...
test('hero follows responsive source aspect ratios instead of forcing viewport height', () => {
  ...
  assert.match(hero, /aspect-\[1036\/1519\]/)
